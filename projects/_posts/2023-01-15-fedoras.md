...
```
@inproceedings{laskaridis2022fedoras_openreview,
  title     = {Cross-device Federated Architecture Search},
  author    = {Laskaridis, Stefanos and Fernandez-Marques, Javier and Dudziak, {\L}ukasz},
  booktitle = {FL-NeurIPS (Workshop on Federated Learning, NeurIPS)},
  year      = {2022},
  url       = {https://openreview.net/forum?id=C1NtSM4Q4i3}
}
```