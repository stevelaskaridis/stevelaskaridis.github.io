...
**Authors:** Samuel Horvàth, **Stefanos Laskaridis**, Shashank Rajput, Hongyi Wang
...
```
@inproceedings{Horvàth2024maestro_openreview,
  title     = {Maestro: Uncovering Low-Rank Structures via Trainable Decomposition},
  author    = {Horvàth, Samuel and Laskaridis, Stefanos and Rajput, Shashank and Wang, Hongyi},
